    ...
    return (
        <section className="checkout-page review-page">
            ...
            <div className="checkout-heading">
                ...
                <p>Please check the details below before placing your order.</p>
            </div>
            ...
            <div className="review-layout">
                <div className="review-content">
                    <section className="review-section">
                        <div className="review-section-heading">
                            ...
                            <div><span>Delivery</span><h2>Shipping address</h2></div>
                    ...
                    <section className="review-section">
                        <div className="review-section-heading">
                            ...
                            <div><span>Payment</span><h2>Payment method</h2></div>
                    ...
                    <section className="review-section review-items-section">
                        <div className="review-section-heading">
                            ...
                            <div><span>Your selection</span><h2>{itemCount} {itemCount === 1 ? 'item' : 'items'}</h2></div>
                ...
                <aside className="review-summary">
                    ...
                    <div className="review-summary-row"><span>Tax</span><strong>{'$' + totals.taxPrice.toFixed(2)}</strong></div>
                    <div className="review-summary-total"><span>Total</span><strong>{'$' + totals.totalPrice.toFixed(2)}</strong></div>
