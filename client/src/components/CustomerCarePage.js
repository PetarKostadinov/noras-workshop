  ...
  en: {
    ...
    faq: {
      ...
      questions: [
        ...
        ['Do I need an account?', 'No. You can check out as a guest. An account is optional and lets you keep an order history and manage your profile.'],
  ...
  bg: {
    ...
    faq: {
      ...
      questions: [
        ...
        ['Необходим ли е профил?', 'Не. Можете да поръчате като гост. Профилът е по желание и ви дава история на поръчките и управление на личните данни.'],
